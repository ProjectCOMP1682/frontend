            ...
            <div className="col-12 grid-margin">
                <div className="card bg-white p-6 rounded-lg shadow-lg">
                    <div className="card-body">
                        <h4 className="text-xl font-semibold">List of job levels</h4>

                        <Input.Search  onSearch={handleSearch} className='mt-5 mb-5' placeholder="Enter job level name " allowClear enterButton="Search">
                        </Input.Search>
                        <div className="overflow-x-auto pt-2">
                            <table className="table w-full border border-gray-300">
                                ...
                                <tr className="bg-gray-100">
                                    ...
                                    <th className="border border-gray-300 px-4 py-2">                                           Job Level Name
                                        </th>
                                            ...
                                            return (
                                                <tr key={index}  className="bg-white hover:bg-gray-50">
                                                    ...
                                                    <td className="border border-gray-300 px-4 py-2">
                                                        <Link style={{ color: '#4B49AC' }} to={`/admin/edit-job-level/${item.code}/`}>Edit</Link>
                                                        &nbsp; &nbsp;
