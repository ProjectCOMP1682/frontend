        ...
        if (isActionADD === true) {
            ...
            setTimeout(() => {
                ...
                if (res && res.errCode === 0) {
                    toast.success("Add salary range successfully")
                    setInputValues({
                        ...inputValues,
                        ["value"]: '',
                        ["code"]: '',
                ...
                else toast.error("Add failed salary range")
            }, 50);
        } else {
            ...
            setTimeout(() => {
                ...
                else toast.error("Salary range update failed")
            }, 50);
        }
    }
        ...
        <div className="col-12 grid-margin">
            <div className="w-full">
                <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <h4 className="card-title">{isActionADD === true ? 'Add new salary range' : 'Update salary range'}</h4>
                        <br></br>
                    <form className="space-y-6">
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="block font-medium">Salary Range Name</label>
