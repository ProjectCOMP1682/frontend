            ...
            <div className="col-12 grid-margin">
                <div className="card bg-white p-6 rounded-lg shadow-lg">
                    <div className="card-body">
                        <h4 className="text-xl font-semibold">List of post packages</h4>
                        <Input.Search onSearch={handleSearch} className='mt-5 mb-5' placeholder="Enter post package name" allowClear enterButton="Search">
                        </Input.Search>
                                        ...
                                        dataPackagePost.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index}  className="bg-white hover:bg-gray-50">
                                                    ...
                                                    <td className="border border-gray-300 px-4 py-2">{item.isHot == 0 ? 'Normal Package' : 'Featured Package'}</td>
                                                    <td className="border border-gray-300 px-4 py-2">{item.isActive == 0 ? 'Out of business' : 'In business'}</td>
                                                    <td className="border border-gray-300 px-4 py-2">
                                                        <Link style={{ color: '#4B49AC' }} to={`/admin/edit-package-post/${item.id}/`}>Edit</Link>
                                                        &nbsp; &nbsp;
                                                        {item.isActive == 1 ? (
                                                            <>
