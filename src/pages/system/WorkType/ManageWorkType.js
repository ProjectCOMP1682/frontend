            ...
            <div className="col-12 grid-margin">
                <div className="card bg-white p-6 rounded-lg shadow-lg">
                    <div className="card-body">
                        <h4 className="text-xl font-semibold">Danh sách hình thức làm việc</h4>

                        <Input.Search  onSearch={handleSearch} placeholder="Enter the name of the work type" allowClear enterButton="Search">
                        </Input.Search>
                                            ...
                                            return (
                                                <tr key={index}  className="bg-white hover:bg-gray-50">
                                                    ...
                                                    <td className="border border-gray-300 px-4 py-2">
                                                        <Link style={{ color: '#4B49AC' }} to={`/admin/edit-work-type/${item.code}/`}>Edit</Link>
                                                        &nbsp; &nbsp;
